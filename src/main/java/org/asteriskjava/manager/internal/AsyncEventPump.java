...
public class AsyncEventPump implements Dispatcher, Runnable
{
	...
	/**
	 * @param owner:
	 *            A weak reference to the owner is created, should it be garbage
	 *            collected then AsyncEventPump will shutdown.
	 * @param dispatcher:
	 *            The dispatcher that AsyncEventPump should deliver events to.
	 * @param threadName:
	 *            The AsyncEventPump's thread will be named with a variant of
	 *            threadName
	 */
